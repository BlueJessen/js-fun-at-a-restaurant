...
var vegetables = ['celery', 'lettuce', 'broccoli', 'peppers', 'carrots'];
...
// different fruits.
var fruits = ['strawberries','oranges','bananas','kiwi','grape','watermelon','cantaloupe'];
...
//function to evaluate if grocery store is busy
function evaluateFootTraffic(peopleInStore){
  if (peopleInStore < 20){
    return false;
  }else{
    return true;
